...
function showLibraryInfo() {
  ...
  for(let i=0; i<myLibrary.length; i++ )
  {
    ...
    else if(myLibrary[i].style === false)
    {
      unreadCounter =1;
...
function showBooksInLibrary() {
  ...
  // yaha par arr data ko string main chang tab localstor sa ho ga
  localStorage.setItem('books',JSON.stringify(myLibrary));
  showLibraryInfo(); //call function
  var bookList = document.getElementById("table-body");
